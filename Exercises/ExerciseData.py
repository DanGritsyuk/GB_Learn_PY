    ...
    def __init__(self):
        self.Descriptions = {
            ...
            'ДОМАШНЕЕ ЗАДАНИЕ №5': [
                ...
                'Задача 3. Создайте игру в крестики-нолики.',
                'Задача 4. Двумерный массив размером 5х5 заполнен случайными нулями и единицами. Игрок может ходить только по полям, заполненным единицами. Проверьте, существует ли путь из точки [0, 0] в точку [4, 4].',
            ]
        }
